// Slug generator + parser for the entity-file naming convention.
// Format: <first>-<source>-<city>[-<n>].md
// The optional -<n> suffix disambiguates collisions (two Carolines on Tinder in Austin -> caroline-tinder-austin, caroline-tinder-austin-2).
