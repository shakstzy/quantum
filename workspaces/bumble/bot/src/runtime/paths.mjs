...
export const RAW_DIR = resolve(QUANTUM_ROOT, "raw/bumble");
export const INGEST_LOG = resolve(QUANTUM_ROOT, "raw/.ingest-log");
export const WATERMARK_FILE = resolve(INGEST_LOG, "bumble.watermark");
...
export const STATE_HOME = resolve(homedir(), ".quantum/bumble");
...
export const DEV_FIXTURES_DIR = resolve(BOT_ROOT, ".dev-fixtures");
